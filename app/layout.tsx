...
export const metadata: Metadata = {
  title: 'Dr. Pattarapornd Suparcha (ภัทรภร ทรัพย์อาชา) | General Practitioner & M.Sc. Candidate',
  ...
  keywords: ['general practitioner', 'occupational health', 'aesthetic medicine', 'anti-aging', 'regenerative science', 'Bangkok doctor', 'teaching assistant', 'digital artist', 'ภัทรภร ทรัพย์อาชา', 'pattarapornd suparcha'],
}
